...
void MainThread::search() {
  ...
  moduloStockfish::Modulo::setBestMove(UCI::move(bestThread->rootMoves[0].pv[0], rootPos.is_chess960()));
  ...
  moduloStockfish::Modulo::setDone(true);
}
